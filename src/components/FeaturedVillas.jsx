...
const FeaturedVillas = () => {
  ...
  return (
    <section
      id="villas"
      className="py-32 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-white via-amber-50/40 to-white relative overflow-hidden"
    >
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-24">
          ...
          <h2 className="text-6xl md:text-7xl font-black text-slate-900 mb-8 leading-tight">
            EXPLORE OUR{" "}
          ...
          <p className="text-xl text-slate-600 max-w-3xl mx-auto font-light tracking-wide">
        ...
        <div className="bg-white border border-amber-200 rounded-2xl p-16 mb-16 backdrop-blur shadow-sm">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
            {[
              ...
              <div key={idx} className="text-center group">
                ...
                <p className="text-5xl font-black bg-gradient-to-r from-amber-400 to-amber-600 bg-clip-text text-transparent mb-2">
                  {stat.number}
                </p>
                <p className="text-amber-700 font-bold text-lg tracking-wide uppercase">
                  {stat.label}
                </p>
              </div>
            ))}
